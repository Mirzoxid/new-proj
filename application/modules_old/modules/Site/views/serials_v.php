    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title" style="background-color: rgba(10,28,204,0.50); padding: 3px;">Arranged</h3><h3 class="box-title" style="margin-left: 10px;background-color: rgba(204,53,0,0.50); padding: 3px;">Not arranged</h3>
        ...
        <div class="box-body">
              ...
              <table id="example" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo site_url() . '/Site/sorting/' . $value->id.'/'.$back ?>" class="btn btn-default <?php echo ($value->sorted == 1 || $value->is_url_extruct == 1) ? 'disabled' : '' ?>">AUTO</a><a style="margin-left: 3px;" href="<?php echo site_url() . '/Site/manual1/' . $value->id ?>" class="btn btn-default <?php echo ($value->sorted == 1)?'disabled':'' ?>">MANUAL</a></td>
