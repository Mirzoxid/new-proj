...
$urls = array(
    'all_movies' => (($this->uri->segment(1) === 'Site' || $this->uri->segment(1) == false) &&
        !(($this->uri->segment(2) === 'serials') || ($this->uri->segment(2) === 'notextructed') ||
            ($this->uri->segment(2) === 'one_movie')||($this->uri->segment(2) === 'separated_movies') || ($this->uri->segment(2) === 'separated_serials')) )? 'active':'',
    'separation' => (($this->uri->segment(2) === 'serials') || ($this->uri->segment(2) === 'notextructed'))? 'active':'',
    'tv' => '',
    ...
    'others' => ($this->uri->segment(2) === 'notextructed')? 'active':'',
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?php echo $urls['separation']?>">
          ...
          <ul class="treeview-menu">
            <li class="<?php echo $urls['identified'] ?>"><a href="<?php echo site_url()?>/Site/serials"><i class="fa fa-circle-o"></i> Detected as a series</a></li>
            <li class="<?php echo $urls['others'] ?>"><a href="<?php echo site_url()?>/Site/notextructed"><i class="fa fa-circle-o"></i> Others</a></li>
