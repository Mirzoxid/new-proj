        ...
        <div class="box-body">
              ...
              <table id="example" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo site_url() . '/Site/manual_movie/' . $value->id ?>" class="btn btn-default <?php echo ($value->sorted == 1)?'disabled':'' ?>">MANUAL</a>
                  </td>
                  <td>
                    <a href="<?php echo site_url() . '/Site/clear_u/' . $value->id . '/notextracted' ?>" class="btn btn-danger <?php echo ($value->sorted == 0 && $value->is_url_extruct == 0) ? 'disabled' : ''?>">DISMISS</a>
                  </td>
                </tr>
            	<?php endforeach ?>
                </tbody>
